...
Implementation plan for the AI shopping assistant. This feature is intentionally isolated from checkout, authentication, orders, and admin functionality.
...
- Keep the existing production branch untouched until the feature is reviewed and tested.
